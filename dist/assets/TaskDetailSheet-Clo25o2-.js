import { t as Circle } from "./circle-DvhkSKsb.js";
import { t as Clock } from "./clock-DwDWGTXK.js";
import { t as Ellipsis } from "./ellipsis-y-Kp7_M3.js";
import { a as Checkbox, o as MessageSquare } from "./tabs-B2mX55jM.js";
import { t as Trash2 } from "./trash-2-CtfolUfW.js";
import { $t as useNavigate, At as Check, Kt as require_jsx_runtime, Lt as useLayoutEffect2, Mt as createLucideIcon, R as Primitive, Tt as CircleAlert, a as SelectItem, b as Sheet, f as ptBR, ht as Plus, i as SelectContent, in as __toESM, jt as Calendar, k as useProjectStore_default, m as format, nn as require_react, o as SelectTrigger, r as Select, rn as __commonJSMin, s as SelectValue, u as generateId, ut as cn, vt as Network, x as SheetContent, zt as useCallbackRef } from "./index-Dx7DXd78.js";
import { t as Badge } from "./badge-D42ee-2w.js";
import { n as CardContent, t as Card } from "./card-B3zo1T62.js";
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							type: "date",
							value: isValidDate$1(task.deadline) ? format(new Date(task.deadline), "yyyy-MM-dd") : "",
							onChange: (e) => onUpdate({ deadline: e.target.value ? new Date(e.target.value).toISOString() : "" }),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: isValidDate$1(task.deadline) ? format(new Date(task.deadline), "dd 'de' MMM, yyyy", { locale: ptBR }) : "Sem data"
						})
					]
				})]
			}),
...
function TaskActivity({ task }) {
	const mockActivity = [{
		...
		date: isValidDate(task.deadline) ? (/* @__PURE__ */ new Date(new Date(task.deadline).getTime() - 864e5)).toISOString() : (/* @__PURE__ */ new Date()).toISOString()
	}, ...(task.comments || []).map((c) => ({
		type: "comment",
		date: c.createdAt,
		...c
			...
			children: item.type === "history" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -left-[30px] top-1.5 w-[14px] h-[14px] rounded-full bg-[#E8E2D9] border-[3px] border-[#FAF7F2] z-10" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						children: isValidDate(item.date) ? format(new Date(item.date), "dd MMM, HH:mm", { locale: ptBR }) : ""
					})
				]
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: isValidDate(item.date) ? format(new Date(item.date), "dd 'de' MMM, HH:mm", { locale: ptBR }) : ""
				})]
			})] })
		}, item.id))
	})] });
...
//# sourceMappingURL=TaskDetailSheet-Clo25o2-.js.map