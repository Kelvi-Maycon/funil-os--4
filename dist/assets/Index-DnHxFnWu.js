...
var safeFormat = (dateStr, fmt) => {
	const d = parseDate(dateStr);
	return d ? format(d, fmt) : "Sem data";
};
function Index() {
	const [projectsData] = useProjectStore_default();
	const [tasksData] = useTaskStore_default();
	const [funnelsData] = useFunnelStore_default();
	const [docsData] = useDocumentStore_default();
	...
	const pendingTasks = tasks.filter((t) => t?.status && t.status !== "Concluído");
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
									...
									children: [overdueTasks.slice(0, 4).map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											children: safeFormat(t.deadline, "dd/MM")
										})]
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [pendingTasks.slice(0, 5).map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											children: safeFormat(t.deadline, "dd/MM/yyyy")
										})]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
										variant: "outline",
								...
								}, t.id)), pendingTasks.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
//# sourceMappingURL=Index-DnHxFnWu.js.map